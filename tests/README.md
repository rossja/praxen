...
**Baseline expectation:** ≈ 3-7 Critical / 6-10 High / 1-5 Medium, weighted ≈ 0.3-0.9 / 5.0 (Absent). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 3-7 Critical / 4-8 High / 1-5 Medium, weighted ≈ 0.2-0.8 / 5.0 (Absent). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 1-5 Critical / 2-6 High / 2-6 Medium, weighted ≈ 0.7-1.4 / 5.0 (Ad hoc). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 1-5 Critical / 3-7 High / 1-5 Medium, weighted ≈ 0.6-1.3 / 5.0 (Absent → Ad hoc). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 2-6 Critical / 4-8 High / 2-6 Medium, weighted ≈ 1.0-1.7 / 5.0 (Ad hoc). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation (README scope):** ≈ 3-7 Critical / 1-5 High / 3-7 Medium, weighted ≈ 0.7-1.3 / 5.0 (Ad hoc, scope-dependent). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 5-9 Critical / 7-11 High / 2-6 Medium / 0-2 Info, weighted ≈ 0.3-0.9 / 5.0 (Absent). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 1-5 Critical / 2-6 High / 1-4 Medium, weighted ≈ 1.1-1.8 / 5.0 (Ad hoc). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 2-6 Critical / 2-6 High / 2-6 Medium, weighted ≈ 1.8-2.5 / 5.0 (Partial). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 0-2 Critical / 0-3 High / 3-7 Medium, weighted ≈ 2.1-2.8 / 5.0 (Partial). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
...
**Baseline expectation:** ≈ 0-4 Critical / 1-5 High / 1-5 Medium, weighted ≈ 1.8-2.5 / 5.0 (Partial). Frozen at [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).

---

## What a release review looks like

The release review is a **full compare**: run all eleven targets and diff each against the latest frozen baseline, [`baselines/v0.7.7-sequential/`](baselines/v0.7.7-sequential/BASELINE.md).
