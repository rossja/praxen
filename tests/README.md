...
The release review is a **full compare**: run all eleven targets and diff each against the latest frozen baseline, [`baselines/v0.7.7-claude48/`](baselines/v0.7.7-claude48/BASELINE.md).
